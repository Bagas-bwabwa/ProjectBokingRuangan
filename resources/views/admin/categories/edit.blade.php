        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header border-0">
                    <h3 class="mb-0">Edit Kategori Ruangan</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('jumlah_ruangan') is-invalid @enderror" id="jumlah_ruangan" name="jumlah_ruangan" value="{{ old('jumlah_ruangan', $category->jumlah_ruangan ?? 0) }}" min="0" required>
