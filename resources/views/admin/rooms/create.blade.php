                ...
                <div class="card-body">
                    <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('jumlah_ruangan') is-invalid @enderror" id="jumlah_ruangan" name="jumlah_ruangan" value="{{ old('jumlah_ruangan', 1) }}" min="1" required>
